...
document.getElementById("op-tricolor-H").addEventListener('click', convertirTricolorHorizontal, false);
...
document.getElementById("realce").addEventListener('click', realceDos, false);
